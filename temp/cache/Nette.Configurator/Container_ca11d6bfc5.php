<?php
class Container_ca11d6bfc5 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Forms\FormFactory' => [1 => ['70_App_Forms_FormFactory']],
			'App\Forms\SignInFormFactory' => [1 => ['71_App_Forms_SignInFormFactory']],
			'App\Forms\SignUpFormFactory' => [1 => ['72_App_Forms_SignUpFormFactory']],
			'Nette\Security\IAuthenticator' => [1 => ['73_App_Model_UserManager']],
			'App\Model\UserManager' => [1 => ['73_App_Model_UserManager']],
		...
		'services' => [
			'70_App_Forms_FormFactory' => 'App\Forms\FormFactory',
			'71_App_Forms_SignInFormFactory' => 'App\Forms\SignInFormFactory',
			'72_App_Forms_SignUpFormFactory' => 'App\Forms\SignUpFormFactory',
			'73_App_Model_UserManager' => 'App\Model\UserManager',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\AntStudioTestProject\app',
			'wwwDir' => 'C:\xampp\htdocs\AntStudioTestProject\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\AntStudioTestProject\app/../temp',
	...
	public function createService__70_App_Forms_FormFactory(): App\Forms\FormFactory
	{
	...
	public function createService__71_App_Forms_SignInFormFactory(): App\Forms\SignInFormFactory
	{
		$service = new App\Forms\SignInFormFactory($this->getService('70_App_Forms_FormFactory'),
			$this->getService('security.user'));
		return $service;
	}


	public function createService__72_App_Forms_SignUpFormFactory(): App\Forms\SignUpFormFactory
	{
		$service = new App\Forms\SignUpFormFactory($this->getService('70_App_Forms_FormFactory'),
			$this->getService('73_App_Model_UserManager'));
		return $service;
	}


	public function createService__73_App_Model_UserManager(): App\Model\UserManager
	{
	...
	public function createServiceAnnotations__cache__annotations(): Doctrine\Common\Cache\Cache
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Annotations',
			true);
		$service->setNamespace('Kdyby_annotations.cache.annotations_22cabece');
		return $service;
	}
	...
	{
		$service = new App\Presenters\SignPresenter($this->getService('71_App_Forms_SignInFormFactory'),
			$this->getService('72_App_Forms_SignUpFormFactory'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\AntStudioTestProject\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\AntStudioTestProject\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\AntStudioTestProject\app/../temp/cache',
	...
	public function createServiceDoctrine__cache__default__dbalResult(): Doctrine\Common\Cache\Cache
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.dbalResult',
			false);
		$service->setNamespace('Kdyby_doctrine.cache.default.dbalResult_22cabece');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__hydration(): Doctrine\Common\Cache\Cache
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.hydration',
			false);
		$service->setNamespace('Kdyby_doctrine.cache.default.hydration_22cabece');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__metadata(): Doctrine\Common\Cache\Cache
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.metadata',
			false);
		$service->setNamespace('Kdyby_doctrine.cache.default.metadata_22cabece');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__ormResult(): Doctrine\Common\Cache\Cache
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.ormResult',
			false);
		$service->setNamespace('Kdyby_doctrine.cache.default.ormResult_22cabece');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__query(): Doctrine\Common\Cache\Cache
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.query',
			false);
		$service->setNamespace('Kdyby_doctrine.cache.default.query_22cabece');
		return $service;
	}
	...
	{
		$service = new Kdyby\Doctrine\Mapping\AnnotationDriver(['C:\xampp\htdocs\AntStudioTestProject\app'],
	...
	public function createServiceDoctrine__default__driver__Kdyby_Doctrine__annotationsImpl(): Doctrine\Common\Persistence\Mapping\Driver\MappingDriver
	{
		$service = new Kdyby\Doctrine\Mapping\AnnotationDriver([
			'C:\xampp\htdocs\AntStudioTestProject\vendor\kdyby\doctrine\src\Kdyby\Doctrine\DI/../Entities',
		], $this->getService('annotations.reader'), $this->getService('doctrine.cache.default.metadata'));
		return $service;
	}
	...
	public function createServiceDoctrine__default__ormConfiguration(): Kdyby\Doctrine\Configuration
	{
		...
		$service->setProxyDir('C:\xampp\htdocs\AntStudioTestProject\app/../temp/proxies');
	...
	public function createServiceDoctrine__repositoryFactory__default__defaultRepositoryFactory(): Kdyby\Doctrine\DI\IRepositoryFactory
	{
		return new class ($this) implements Kdyby\Doctrine\DI\IRepositoryFactory {
			...
			public function __construct(Container_ca11d6bfc5 $container)
			{
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\AntStudioTestProject\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Security\User($this->getService('security.userStorage'), $this->getService('73_App_Model_UserManager'));
	...
	{
		Kdyby\Doctrine\Proxy\ProxyAutoloader::create('C:\xampp\htdocs\AntStudioTestProject\app/../temp/proxies', 'Kdyby\GeneratedProxy')->register();Doctrine\Common\Annotations\AnnotationRegistry::registerLoader("class_exists");
		...
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = 'C:\xampp\htdocs\AntStudioTestProject\vendor\kdyby\doctrine\src\Kdyby\Doctrine';
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = 'C:\xampp\htdocs\AntStudioTestProject\vendor\doctrine';
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = 'C:\xampp\htdocs\AntStudioTestProject\app/../temp/proxies';
	}
}
